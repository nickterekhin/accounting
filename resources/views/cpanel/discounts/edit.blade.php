                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="Title" class="form-control" id="Title" value="{!! $discount->getTitle() !!}" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="AMount">Amount</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="Amount" class="form-control" id="Amount" value="{!! $discount->getAmount() !!}" required min="0" step="0.01"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10 text-left">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="Active" value="1" @if($discount->IsActive())checked="checked"@endif> Active
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-block btn-success btn-md"><i class="fa fa-floppy-o"></i>Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
